...
<?php
  if(isset($_POST['add'])){
   ...
   if(find_by_groupName($_POST['group-name']) === false ){
     ...
     $session->msg('d','<b>Sorry!</b> Entered Department Level already in database!');
     redirect('add_group.php', false);
   }
   if(empty($errors)){
        ...
        if($db->query($query)){
          ...
          //failed
          $session->msg('d',' Sorry failed to create Department!');
          redirect('add_group.php', false);
        }
   } else {
    ...
    <div class="text-center">
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="add_group.php" class="clearfix">
        ...
        <div class="form-group">
              <label for="level" class="control-label">Department Level</label>
